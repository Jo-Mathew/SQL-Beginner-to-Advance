...
--Query list all details of partition
SELECT
    name,
    function_id,
    type,
...
--QUIERY LISTING ALL FILEGROUPS
SELECT * 
FROM sys.filegroups
WHERE type = 'FG'

--STEP 3: ADD .ndf file to each filegroup
...
INSERT INTO Sales.Orders_Partitioned VALUES (2, '2024-05-15', 100);
...
--NOW CHECK WITH A TABLE WITH PARTITION AND NO PARTITION
--WITH PARTITION IS IS QUICK AS COMPARED TO NO PARTITION AS IT CHECKS ALL ROWS
